...
const useSidebarEffect = (elementRef) => {
    useEffect(() => {
        ...
        let backGroundGradient, overlayGradient, canvasCenterX, canvasCenterY;
        const nodes = [];
        ...
        function redraw() {
            ...
            backGroundGradient = context.createRadialGradient(canvasCenterX, canvasCenterY, 0, canvasCenterX, canvasCenterY, canvasCenterX);
        ...
        function render() {
            ...
            for (; i < len; i++) {
                ...
                const gradient = context.createRadialGradient(0, 0, 0, 0, 0, node.radius);
        ...
        for (let i = 0; i < 100; i++) {
            ...
            const fakeBlur = Math.random() * 0.3 + 0.7;
...
export default useSidebarEffect;